...
#Region "Events"
    ...
    Event OnInsert(objStatus As Status)

    Event OnUpdate(objStatus As Status)

    Event OnDelete(objStatus As Status)
...
#Region "Constructors"
    ...
    Public Sub New(strStatusCode As String)
        ...
        If String.IsNullOrEmpty(strStatusCode) Then strStatusCode = "0000"
