...
''' <summary>
'''     Provides methods for accessing, creating and manipulating a PhoneType object.
''' </summary>

    Public Class PhoneType
    Inherits TlkpPhoneType

#Region "Events"

    Event OnInsert(objPhoneType As PhoneType)

    Event OnUpdate(objPhoneType As PhoneType)

    Event OnDelete(objPhoneType As PhoneType)
...
#Region "Constructors"
    ...
    ''' <summary>
    '''     Initializes a new instance of the PhoneType class.
    ''' </summary>
    ''' <param name="objDataRow">
    '''     A DataRow object containing the values that the PhoneType is to be initialized with.
    ''' </param>
    ''' <remarks>
...
#Region "Public Methods"
    ...
    ''' <summary>
    '''     Inserts the PhoneType into the database.
    ''' </summary>
    ''' <returns>
    '''     True if the PhoneType object has been successfully inserted, otherwise false.
    ''' </returns>
    ...
    ''' <summary>
    '''     Updates a PhoneType object in the database
    ''' </summary>
    ''' <returns>
    ...
    ''' <summary>
    '''     Deletes a PhoneType from the database
    ''' </summary>
    ''' <returns>
    '''     True if successful, otherwise False
    ''' </returns>
