...
Public Class PhoneHistory
    Inherits TblPhoneHistory

    Event OnInsert(objPhoneHistory As PhoneHistory)
    Event OnUpdate(objPhoneHistory As PhoneHistory)
    Event OnDelete(objPhoneHistory As PhoneHistory)
...
#Region "Public Properties"
    ...
    ''' <summary>
    '''     Gets the <see cref="T:MPR.SMS.Data.Phone">Phone</see> object that the PhoneHistory object is associated with.
    ''' </summary>
    ''' <value>
    '''     The <see cref="T:MPR.SMS.Data.Phone">Phone</see> object that the PhoneHistory object is associated with.
    ''' </value>

        Public ReadOnly Property Phone As Phone
        Get
            ' Get the index of the associated Phone object initializing the Phone
            ' object reference as needed.
            If Not PhoneID.IsNull Then

                Dim i As Integer = mobjCase.Phones.IndexOf(PhoneID.Value)

                If i >= 0 Then
                    mobjPhone = mobjCase.Phones(i)
                End If
            End If
...
#Region "Constructors"
    ...
    ''' <summary>
    '''     Initializes a new instance of the PhoneHistory class.
    ''' </summary>
    ''' <param name="objCase">
    '''     The Case that the PhoneHistory object belongs to.
    ''' </param>
    ''' <param name="objDataRow">
    '''     A DataRow object containing the values that the PhoneHistory object is to be initialized with.
    ''' </param>
    ''' <remarks>
    ...
    '''     The PhoneHistoryID to retrieve
    ''' </param>
    ''' <remarks>
    ...
    ''' </remarks>
        ...
        'Dim obj As New TblPhoneHistory
        'obj.ConnectionString = Project.ConnectionString
        'obj.PhoneHistoryID = PhoneHistoryID
        ...
        MyBase.PhoneHistoryID = New SqlInt32(intHistoryID)
...
#Region "Public Methods"
    ...
    ''' <summary>
    '''     Inserts a PhoneHistory object into the database.
    ''' </summary>
    ''' <returns>
    ...
    ''' <summary>
    '''     Updates a PhoneHistory object within the database.
    ''' </summary>
    ''' <returns>
    '''     True if successful, otherwise False.
    ''' </returns>
    ...
    ''' <summary>
    '''     Deletes a PhoneHistory object from the database.
    ''' </summary>
    ''' <returns>
    '''     True if successful, otherwise False.
    ''' </returns>
