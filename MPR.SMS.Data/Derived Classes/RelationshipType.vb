...
''' <summary>
'''     Provides methods for accessing, creating and manipulating a Relationship object.
''' </summary>

    Public Class RelationshipType
    Inherits TlkpRelationshipType

#Region "Events"

    Event OnInsert(objRelationship As RelationshipType)

    Event OnUpdate(objRelationship As RelationshipType)

    Event OnDelete(objRelationship As RelationshipType)
...
#Region "Constructors"
    ...
    '''     A DataRow object containing the values that the Relationship is to be initialized with.
    ''' </param>
    ''' <remarks>
