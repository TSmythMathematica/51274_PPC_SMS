...
#Region "private utility methods & constructors"
        ...
        If (Not commandParameters Is Nothing) Then
            ...
            For Each p In commandParameters
                If (Not p Is Nothing) Then
                    ...
                    If _
                        (p.Direction = ParameterDirection.InputOutput OrElse p.Direction = ParameterDirection.Input) AndAlso
    ...
    Private Overloads Shared Sub AssignParameterValues(commandParameters() As SqlParameter, dataRow As DataRow)
    ...
    Private Overloads Shared Sub AssignParameterValues(commandParameters() As SqlParameter, parameterValues() As Object)
    ...
    Private Shared Sub PrepareCommand(command As SqlCommand,
                                      connection As SqlConnection,
                                      transaction As SqlTransaction,
                                      commandType As CommandType,
                                      commandText As String,
                                      commandParameters() As SqlParameter, ByRef mustCloseConnection As Boolean)
        ...
        If Not (transaction Is Nothing) Then
            If transaction.Connection Is Nothing Then _
                Throw _
...
#Region "ExecuteNonQuery"
    ...
    Public Overloads Shared Function ExecuteNonQuery(connectionString As String,
                                                     commandType As CommandType,
                                                     commandText As String) As Integer
    ...
    Public Overloads Shared Function ExecuteNonQuery(connectionString As String,
        ...
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: An int representing the number of rows affected by the command
    Public Overloads Shared Function ExecuteNonQuery(connection As SqlConnection,
                                                     commandType As CommandType,
                                                     commandText As String) As Integer
        ' Pass through the call providing null for the set of SqlParameters
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: An int representing the number of rows affected by the command 
    Public Overloads Shared Function ExecuteNonQuery(transaction As SqlTransaction,
                                                     commandType As CommandType,
                                                     commandText As String) As Integer
        ' Pass through the call providing null for the set of SqlParameters
    ...
    Public Overloads Shared Function ExecuteNonQuery(transaction As SqlTransaction,
        ...
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then _
            Throw _
                New ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.",
                                      "transaction")
...
#Region "ExecuteDataset"
    ...
    Public Overloads Shared Function ExecuteDataset(connectionString As String,
                                                    commandType As CommandType,
                                                    commandText As String) As DataSet
        ' Pass through the call providing null for the set of SqlParameters
    ...
    ' -commandText - the stored procedure name or T-SQL command
    ' Returns: A dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDataset(connection As SqlConnection,
                                                    commandType As CommandType,
                                                    commandText As String) As DataSet
    ...
    ' -commandText - the stored procedure name or T-SQL command
    ' Returns: A dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDataset(transaction As SqlTransaction,
                                                    commandType As CommandType,
                                                    commandText As String) As DataSet
        ' Pass through the call providing null for the set of SqlParameters
...
#Region "ExecuteReader"
    ...
    Private Overloads Shared Function ExecuteReader(connection As SqlConnection,
                                                    transaction As SqlTransaction,
                                                    commandType As CommandType,
                                                    commandText As String,
    ...
    Public Overloads Shared Function ExecuteReader(connectionString As String,
                                                   commandType As CommandType,
    ...
    Public Overloads Shared Function ExecuteReader(connectionString As String,
        ...
        Try
            ...
            Return _
                ExecuteReader(connection, CType(Nothing, SqlTransaction), commandType, commandText, commandParameters,
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: A SqlDataReader containing the resultset generated by the command 
    Public Overloads Shared Function ExecuteReader(connection As SqlConnection,
                                                   commandType As CommandType,
                                                   commandText As String) As SqlDataReader
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: A SqlDataReader containing the resultset generated by the command 
    Public Overloads Shared Function ExecuteReader(transaction As SqlTransaction,
                                                   commandType As CommandType,
                                                   commandText As String) As SqlDataReader
        ' Pass through the call providing null for the set of SqlParameters
...
#Region "ExecuteScalar"
    ...
    Public Overloads Shared Function ExecuteScalar(connectionString As String,
                                                   commandType As CommandType,
                                                   commandText As String) As Object
        ' Pass through the call providing null for the set of SqlParameters
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: An object containing the value in the 1x1 resultset generated by the command 
    Public Overloads Shared Function ExecuteScalar(connection As SqlConnection,
                                                   commandType As CommandType,
                                                   commandText As String) As Object
        ' Pass through the call providing null for the set of SqlParameters
    ...
    ' -commandText - the stored procedure name or T-SQL command 
    ' Returns: An object containing the value in the 1x1 resultset generated by the command 
    Public Overloads Shared Function ExecuteScalar(transaction As SqlTransaction,
                                                   commandType As CommandType,
                                                   commandText As String) As Object
        ' Pass through the call providing null for the set of SqlParameters
...
#Region "ExecuteXmlReader"
    ...
    Public Overloads Shared Function ExecuteXmlReader(connection As SqlConnection,
                                                      commandType As CommandType,
                                                      commandText As String) As XmlReader
        ' Pass through the call providing null for the set of SqlParameters
    ...
    ' -commandText - the stored procedure name or T-SQL command using "FOR XML AUTO" 
    ' Returns: An XmlReader containing the resultset generated by the command 
    Public Overloads Shared Function ExecuteXmlReader(transaction As SqlTransaction,
                                                      commandType As CommandType,
                                                      commandText As String) As XmlReader
        ' Pass through the call providing null for the set of SqlParameters
...
#Region "FillDataset"
    ...
    Public Overloads Shared Sub FillDataset(connectionString As String, commandType As CommandType,
                                            commandText As String, dataSet As DataSet, tableNames() As String)
    ...
    ' -commandParameters: An array of SqlParamters used to execute the command
    Public Overloads Shared Sub FillDataset(connectionString As String, commandType As CommandType,
                                            commandText As String, dataSet As DataSet,
                                            tableNames() As String, ByVal ParamArray commandParameters() As SqlParameter)
    ...
    '             by a user defined name (probably the actual table name)
    ' -parameterValues: An array of objects to be assigned As the input values of the stored procedure
    Public Overloads Shared Sub FillDataset(connectionString As String, spName As String,
                                            dataSet As DataSet, tableNames As String(),
    ...
    ' -tableNames: this array will be used to create table mappings allowing the DataTables to be referenced
    ' by a user defined name (probably the actual table name)
    Public Overloads Shared Sub FillDataset(connection As SqlConnection, commandType As CommandType,
                                            commandText As String, dataSet As DataSet, tableNames As String())
    ...
    '             by a user defined name (probably the actual table name)
    ' -parameterValues: An array of objects to be assigned as the input values of the stored procedure
    Public Overloads Shared Sub FillDataset(connection As SqlConnection, spName As String, dataSet As DataSet,
                                            tableNames() As String, ByVal ParamArray parameterValues() As Object)
    ...
    ' -tableNames: this array will be used to create table mappings allowing the DataTables to be referenced
    '             by a user defined name (probably the actual table name)
    Public Overloads Shared Sub FillDataset(transaction As SqlTransaction, commandType As CommandType,
                                            commandText As String, dataSet As DataSet, tableNames() As String)
    ...
    '             by a user defined name (probably the actual table name)
    ' -parameterValues: An array of objects to be assigned as the input values of the stored procedure
    Public Overloads Shared Sub FillDataset(transaction As SqlTransaction, spName As String,
                                            dataSet As DataSet, tableNames() As String,
                                            ByVal ParamArray parameterValues() As Object)
        ...
        If Not parameterValues Is Nothing AndAlso parameterValues.Length > 0 Then
            ...
            ' Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
            Dim commandParameters() As SqlParameter = SqlHelperParameterCache.GetSpParameterSet(transaction.Connection,
                                                                                                spName)
    ...
    '             by a user defined name (probably the actual table name)
    ' -commandParameters: An array of SqlParamters used to execute the command
    Private Overloads Shared Sub FillDataset(connection As SqlConnection, transaction As SqlTransaction,
                                             commandType As CommandType,
                                             commandText As String, dataSet As DataSet, tableNames() As String,
                                             ByVal ParamArray commandParameters() As SqlParameter)
        ...
        Try
            ...
            If Not tableNames Is Nothing AndAlso tableNames.Length > 0 Then
                ...
                For index = 0 To tableNames.Length - 1
                    If (tableNames(index) Is Nothing OrElse tableNames(index).Length = 0) Then _
                        Throw _
                            New ArgumentException(
...
#Region "UpdateDataset"
    ...
    Public Overloads Shared Sub UpdateDataset(insertCommand As SqlCommand, deleteCommand As SqlCommand,
                                              updateCommand As SqlCommand, dataSet As DataSet, tableName As String)
...
#Region "CreateCommand"
    ...
    Public Overloads Shared Function CreateCommand(connection As SqlConnection, spName As String,
                                                   ByVal ParamArray sourceColumns() As String) As SqlCommand
...
#Region "ExecuteNonQueryTypedParams"
    ...
    Public Overloads Shared Function ExecuteNonQueryTypedParams(connectionString As String, spName As String,
                                                                dataRow As DataRow) As Integer
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns:
    ' an int representing the number of rows affected by the command
    Public Overloads Shared Function ExecuteNonQueryTypedParams(connection As SqlConnection, spName As String,
                                                                dataRow As DataRow) As Integer
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns:
    ' an int representing the number of rows affected by the command
    Public Overloads Shared Function ExecuteNonQueryTypedParams(transaction As SqlTransaction, spName As String,
                                                                dataRow As DataRow) As Integer
...
#Region "ExecuteDatasetTypedParams"
    ...
    Public Overloads Shared Function ExecuteDatasetTypedParams(connectionString As String, spName As String,
                                                               dataRow As DataRow) As DataSet
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns:
    ' a dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDatasetTypedParams(connection As SqlConnection, spName As String,
                                                               dataRow As DataRow) As DataSet
    ...
    ' Returns:
    ' a dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDatasetTypedParams(transaction As SqlTransaction, spName As String,
                                                               dataRow As DataRow) As DataSet
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then _
            Throw _
...
#Region "ExecuteReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteReaderTypedParams(connectionString As String, spName As String,
                                                              dataRow As DataRow) As SqlDataReader
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns:
    ' a SqlDataReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteReaderTypedParams(connection As SqlConnection, spName As String,
                                                              dataRow As DataRow) As SqlDataReader
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns:
    ' a SqlDataReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteReaderTypedParams(transaction As SqlTransaction, spName As String,
                                                              dataRow As DataRow) As SqlDataReader
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then _
            Throw _
...
#Region "ExecuteScalarTypedParams"
    ...
    Public Overloads Shared Function ExecuteScalarTypedParams(connectionString As String, spName As String,
                                                              dataRow As DataRow) As Object
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ' If the row has values, the store procedure parameters must be initialized
    ...
    ' Returns: 
    ' an object containing the value in the 1x1 resultset generated by the command</returns>
    Public Overloads Shared Function ExecuteScalarTypedParams(connection As SqlConnection, spName As String,
                                                              dataRow As DataRow) As Object
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
    ...
    ' Returns: 
    ' an object containing the value in the 1x1 resultset generated by the command</returns>
    Public Overloads Shared Function ExecuteScalarTypedParams(transaction As SqlTransaction, spName As String,
                                                              dataRow As DataRow) As Object
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then _
            Throw _
...
#Region "ExecuteXmlReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(connection As SqlConnection, spName As String,
                                                                 dataRow As DataRow) As XmlReader
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ' If the row has values, the store procedure parameters must be initialized
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = ExecuteXmlReader(connection, CommandType.StoredProcedure, spName,
                                                           commandParameters)
        Else
            ExecuteXmlReaderTypedParams = ExecuteXmlReader(connection, CommandType.StoredProcedure, spName)
        End If
    ...
    ' Returns: 
    ' an XmlReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(transaction As SqlTransaction, spName As String,
                                                                 dataRow As DataRow) As XmlReader
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then _
            Throw _
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName,
                                                           commandParameters)
        Else
            ExecuteXmlReaderTypedParams = ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName)
        End If
...
#Region "private methods, variables, and constructors"
    ...
    Private Shared Function DiscoverSpParameterSet(connection As SqlConnection,
                                                   spName As String,
                                                   includeReturnValueParameter As Boolean,
...
#Region "caching functions"
    ...
    Public Shared Sub CacheParameterSet(connectionString As String,
                                        commandText As String,
                                        ByVal ParamArray commandParameters() As SqlParameter)
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
...
#Region "Parameter Discovery Functions"
    ...
    Public Overloads Shared Function GetSpParameterSet(connectionString As String, spName As String) As SqlParameter()
    ...
    ' Returns: An array of SqlParameters 
    Public Overloads Shared Function GetSpParameterSet(connectionString As String,
                                                       spName As String,
                                                       includeReturnValueParameter As Boolean) As SqlParameter()
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then _
            Throw New ArgumentNullException("connectionString")
        Dim connection As SqlConnection = Nothing
        Try
    ...
    ' -includeReturnValueParameter - a bool value indicating whether the return value parameter should be included in the results 
    ' Returns: An array of SqlParameters 
    Public Overloads Shared Function GetSpParameterSet(connection As SqlConnection,
                                                       spName As String) As SqlParameter()
    ...
    ' -includeReturnValueParameter - a bool value indicating whether the return value parameter should be included in the results 
    ' Returns: An array of SqlParameters 
    Private Overloads Shared Function GetSpParameterSetInternal(connection As SqlConnection,
                                                                spName As String,
                                                                includeReturnValueParameter As Boolean) _
        As SqlParameter()
        ...
        hashKey = connection.ConnectionString + ":" + spName +
                  IIf(includeReturnValueParameter = True, ":include ReturnValue Parameter", "").ToString
