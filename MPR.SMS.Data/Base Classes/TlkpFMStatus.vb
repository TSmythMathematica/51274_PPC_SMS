...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tlkpFMStatus.
	''' </summary>

	Public Class TlkpFMStatus
...
#Region "Private Fields"
		...
		Private _rankingGroup As SqlInt32
		Private _rankingGroupOld As SqlInt32
...
#End Region
		...
		''' <overloads>
		''' The TlkpFMStatus constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TlkpFMStatus class.
		''' </summary>
		...
		Private Sub FillProperties(ByVal objDataRow As DataRow)
			...
			If objDataRow("RankingGroup") Is System.DBNull.Value Then
				_rankingGroup = SqlInt32.Null
			Else
				_rankingGroup = New SqlInt32(CType(objDataRow("RankingGroup"), Integer))
			End If
			
			_rankingGroupOld = _rankingGroup
		...
		Private Sub FillProperties(ByVal objSqlDataReader As SqlDataReader)
			...
			If objSqlDataReader("RankingGroup") Is System.DBNull.Value Then
				_rankingGroup = SqlInt32.Null
			Else
				_rankingGroup = New SqlInt32(CType(objSqlDataReader("RankingGroup"), Integer))
			End If
		...
		Friend Sub RestoreModified()
			...
			_rankingGroup = _rankingGroupOld
		...
		'''		 <LI>RankingGroup. May be SqlInt32.Null</LI>
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tlkpFMStatus_Insert]"
			...
			Try
				...
				cmdToExecute.Parameters.Add(New SqlParameter("@RankingGroup", SqlDbType.Int, 4, ParameterDirection.Input, True, 10, 0, "", DataRowVersion.Proposed, _rankingGroup))
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpFMStatus_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpFMStatus::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpFMStatus_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpFMStatus_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpFMStatus::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpFMStatus_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpFMStatus_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpFMStatus::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpFMStatus_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpFMStatus")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpFMStatus_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpFMStatus::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpFMStatus_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpFMStatus")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpFMStatus_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpFMStatus::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
...
#Region "Public Properties"
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [RankingGroup]() As SqlInt32
			Get
				Return _rankingGroup
			End Get
			Set(ByVal Value As SqlInt32)
				If Not _rankingGroup.Equals(Value) Then
					If _rankingGroupOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _rankingGroup.Equals(_rankingGroupOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
				_rankingGroup = Value
