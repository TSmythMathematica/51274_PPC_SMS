...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tblMelissa_Communication.
	''' </summary>

	Public Class TblMelissa_Communication
		Inherits DBInteractionBase

#Region "Private Fields"

		Private _endDateTime As SqlDateTime
		Private _endDateTimeOld As SqlDateTime
		Private _startDateTime As SqlDateTime
		Private _startDateTimeOld As SqlDateTime
		Private _createdOn As SqlDateTime
		Private _createdOnOld As SqlDateTime

		Private _numberOfRecords As SqlInt32
		Private _numberOfRecordsOld As SqlInt32
...
#End Region
		...
		''' <overloads>
		''' The TblMelissa_Communication constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TblMelissa_Communication class.
		''' </summary>
		...
		Private Sub FillProperties(ByVal objDataRow As DataRow)
			...
			If objDataRow("StartDateTime") Is System.DBNull.Value Then
				_startDateTime = SqlDateTime.Null
			Else
				_startDateTime = New SqlDateTime(CType(objDataRow("StartDateTime"), Date))
			End If
			
			_startDateTimeOld = _startDateTime
			
			If objDataRow("EndDateTime") Is System.DBNull.Value Then
				_endDateTime = SqlDateTime.Null
			Else
				_endDateTime = New SqlDateTime(CType(objDataRow("EndDateTime"), Date))
			End If
			
			_endDateTimeOld = _endDateTime
			
			If objDataRow("NumberOfRecords") Is System.DBNull.Value Then
				_numberOfRecords = SqlInt32.Null
			Else
				_numberOfRecords = New SqlInt32(CType(objDataRow("NumberOfRecords"), Integer))
			End If
			
			_numberOfRecordsOld = _numberOfRecords
			
			If objDataRow("ResultCode") Is System.DBNull.Value Then
		...
		Private Sub FillProperties(ByVal objSqlDataReader As SqlDataReader)
			...
			If objSqlDataReader("StartDateTime") Is System.DBNull.Value Then
				_startDateTime = SqlDateTime.Null
			Else
				_startDateTime = New SqlDateTime(CType(objSqlDataReader("StartDateTime"), Date))
			End If
			
			_startDateTimeOld = _startDateTime
			
			If objSqlDataReader("EndDateTime") Is System.DBNull.Value Then
				_endDateTime = SqlDateTime.Null
			Else
				_endDateTime = New SqlDateTime(CType(objSqlDataReader("EndDateTime"), Date))
			End If
			
			_endDateTimeOld = _endDateTime
			
			If objSqlDataReader("NumberOfRecords") Is System.DBNull.Value Then
				_numberOfRecords = SqlInt32.Null
			Else
				_numberOfRecords = New SqlInt32(CType(objSqlDataReader("NumberOfRecords"), Integer))
			End If
			
			_numberOfRecordsOld = _numberOfRecords
			
			If objSqlDataReader("ResultCode") Is System.DBNull.Value Then
				_resultCode = New SqlString("")
			Else
		...
		Friend Sub RestoreModified()
			...
			_startDateTime = _startDateTimeOld
			
			_endDateTime = _endDateTimeOld
			
			_numberOfRecords = _numberOfRecordsOld
		...
		''' <UL>
		'''		 <LI>StartDateTime. May be SqlDateTime.Null</LI>
		'''		 <LI>EndDateTime. May be SqlDateTime.Null</LI>
		'''		 <LI>NumberOfRecords. May be SqlInt32.Null</LI>
		'''		 <LI>ResultCode. May be SqlString.Null</LI>
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tblMelissa_Communication_Insert]"
			...
			Try
				cmdToExecute.Parameters.Add(New SqlParameter("@StartDateTime", SqlDbType.DateTime, 8, ParameterDirection.Input, True, 0, 0, "", DataRowVersion.Proposed, _startDateTime))
				cmdToExecute.Parameters.Add(New SqlParameter("@EndDateTime", SqlDbType.DateTime, 8, ParameterDirection.Input, True, 0, 0, "", DataRowVersion.Proposed, _endDateTime))
				cmdToExecute.Parameters.Add(New SqlParameter("@NumberOfRecords", SqlDbType.Int, 4, ParameterDirection.Input, True, 10, 0, "", DataRowVersion.Proposed, _numberOfRecords))
				cmdToExecute.Parameters.Add(New SqlParameter("@ResultCode", SqlDbType.NVarChar, 50, ParameterDirection.Input, True, 0, 0, "", DataRowVersion.Proposed, _resultCode))
				cmdToExecute.Parameters.Add(New SqlParameter("@Notes", SqlDbType.NVarChar, 200, ParameterDirection.Input, True, 0, 0, "", DataRowVersion.Proposed, _notes))
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@CommunicationID", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, _communicationID))
				...
				_communicationID = CType(cmdToExecute.Parameters.Item("@CommunicationID").Value, SqlInt32)
				mErrorCode = CType(cmdToExecute.Parameters.Item("@ErrorCode").Value, SqlInt32)

				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblMelissa_Communication_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblMelissa_Communication::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblMelissa_Communication_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblMelissa_Communication_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblMelissa_Communication::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblMelissa_Communication_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblMelissa_Communication_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblMelissa_Communication::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblMelissa_Communication_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblMelissa_Communication")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblMelissa_Communication_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblMelissa_Communication::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblMelissa_Communication_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblMelissa_Communication")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblMelissa_Communication_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblMelissa_Communication::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
...
#Region "Public Properties"
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [StartDateTime]() As SqlDateTime
			Get
				Return _startDateTime
			End Get
			Set(ByVal Value As SqlDateTime)
				If Not _startDateTime.Equals(Value) Then
					If _startDateTimeOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _startDateTime.Equals(_startDateTimeOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [EndDateTime]() As SqlDateTime
			Get
				Return _endDateTime
			End Get
			Set(ByVal Value As SqlDateTime)
				If Not _endDateTime.Equals(Value) Then
					If _endDateTimeOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _endDateTime.Equals(_endDateTimeOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
				_endDateTime = Value
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [NumberOfRecords]() As SqlInt32
			Get
				Return _numberOfRecords
			End Get
			Set(ByVal Value As SqlInt32)
				If Not _numberOfRecords.Equals(Value) Then
					If _numberOfRecordsOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _numberOfRecords.Equals(_numberOfRecordsOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
