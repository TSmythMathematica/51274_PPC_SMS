...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tlkpPhoneTime.
	''' </summary>

	Public Class TlkpPhoneTime
...
#End Region
		...
		''' <overloads>
		''' The TlkpPhoneTime constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TlkpPhoneTime class.
		''' </summary>
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tlkpPhoneTime_Insert]"
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpPhoneTime_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpPhoneTime::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpPhoneTime_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpPhoneTime_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpPhoneTime::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpPhoneTime_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpPhoneTime_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpPhoneTime::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpPhoneTime_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpPhoneTime")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpPhoneTime_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpPhoneTime::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpPhoneTime_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpPhoneTime")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpPhoneTime_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpPhoneTime::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Public Property [PhoneTimeID]() As SqlInt32
			...
			Set(ByVal Value As SqlInt32)
				If Not _phoneTimeID.Equals(Value) Then
					...
					End If
				End If 
				Dim phoneTimeIDTmp As SqlInt32 = Value
				If phoneTimeIDTmp.IsNull Then
					Throw New NullValueException("PhoneTimeID", "PhoneTimeID can't be NULL")
				End If
				_phoneTimeID = Value
			End Set
		End Property
