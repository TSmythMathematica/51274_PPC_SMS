-- Stored Procedures generated by the MPR.Data.Access.Wizard on Monday, September 23, 2013, 4:43:40 PM
SET NOCOUNT ON
GO
USE [SMSBaseV4]
GO
...
-- Gets: @AddressNotes varchar(2000)
-- Gets: @IsCleaned bit
-- Gets: @BPN tinyint
-- Gets: @BIN tinyint
...
-- Gets: @DocumentOutputTypeID int
-- Gets: @CrystalReportShellFilePath varchar(50)
-- Gets: @CrystalReportShellFileName varchar(50)
-- Gets: @OutputFilePath varchar(100)
-- Gets: @OutputFileName varchar(50)
-- Gets: @SampleFilePathName varchar(100)
