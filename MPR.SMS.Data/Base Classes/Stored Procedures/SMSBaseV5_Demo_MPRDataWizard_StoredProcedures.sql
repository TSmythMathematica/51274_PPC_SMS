-- Stored Procedures generated by the MPR.Data.Access.Wizard on Friday, April 16, 2021, 11:56:29 AM
SET NOCOUNT ON
GO
USE [SMSBaseV5_Demo]
GO
...
-- //// Update Stored procedure for updating one or more rows using field [CaseID].
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tblPersonBest_UpdateAllWCaseIDLogic]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tblPersonBest_UpdateAllWCaseIDLogic]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will update one or more existing rows in the table 'tblPersonBest'.
-- Will reset field [CaseID] with value @CaseIDOld  to value @CaseID
-- Gets: @CaseID int
-- Gets: @CaseIDOld int
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tblPersonBest_UpdateAllWCaseIDLogic]
	@CaseID int,
	@CaseIDOld int,
	@ErrorCode int OUTPUT
AS
...
-- //// Select Stored procedure, based on field [CaseID].
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tblPersonBest_SelectAllWCaseIDLogic]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tblPersonBest_SelectAllWCaseIDLogic]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will select one or more existing rows from the table 'tblPersonBest'
-- based on a foreign key field.
-- Gets: @CaseID int
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tblPersonBest_SelectAllWCaseIDLogic]
	@CaseID int,
	@ErrorCode int OUTPUT
AS
SET NOCOUNT ON
...
-- [Stored Procedures generated for table:  tlkpFMStatus]

GO

-- //// Insert Stored procedure.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tlkpFMStatus_Insert]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tlkpFMStatus_Insert]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will insert 1 row in the table 'tlkpFMStatus'
-- Gets: @Code char(4)
-- Gets: @Description varchar(100)
-- Gets: @RankingGroup int
-- Gets: @IsActive bit
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tlkpFMStatus_Insert]
	@Code char(4),
...
-- //// Update Stored procedure for updating one single row.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tlkpFMStatus_Update]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tlkpFMStatus_Update]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will update an existing row in the table 'tlkpFMStatus'
-- Gets: @Code char(4)
-- Gets: @Description varchar(100)
-- Gets: @RankingGroup int
-- Gets: @IsActive bit
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tlkpFMStatus_Update]
	@Code char(4),
	@Description varchar(100),
	@RankingGroup int,
	@IsActive bit,
...
-- //// Delete Stored procedure using Primary Key.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tlkpFMStatus_Delete]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tlkpFMStatus_Delete]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will delete an existing row from the table 'tlkpFMStatus'
-- using the Primary Key. 
-- Gets: @Code char(4)
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tlkpFMStatus_Delete]
	@Code char(4),
	@ErrorCode int OUTPUT
AS
SET NOCOUNT ON
-- DELETE an existing row from the table.
DELETE FROM [dbo].[tlkpFMStatus]
WHERE
	[Code] = @Code
-- Get the Error Code for the statement just executed.
SELECT @ErrorCode=@@ERROR
...
-- //// Select Stored procedure, based on Primary Key.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tlkpFMStatus_SelectOne]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tlkpFMStatus_SelectOne]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will select an existing row from the table 'tlkpFMStatus'
-- based on the Primary Key.
-- Gets: @Code char(4)
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tlkpFMStatus_SelectOne]
	@Code char(4),
	@ErrorCode int OUTPUT
AS
SET NOCOUNT ON
...
-- //// Select All Stored procedure.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_tlkpFMStatus_SelectAll]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_tlkpFMStatus_SelectAll]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will select all rows from the table 'tlkpFMStatus'
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_tlkpFMStatus_SelectAll]
	@ErrorCode int OUTPUT
AS
SET NOCOUNT ON
-- SELECT all rows from the table.
...
-- [End of Stored Procedures for table:     tlkpFMStatus]
...
SET 
	...
	[SurveyID] = @SurveyID,
	[SMSToConfirmitRT] = @SMSToConfirmitRT
WHERE
	[InstrumentTypeID] = @InstrumentTypeID
-- Get the Error Code for the statement just executed.
SELECT @ErrorCode=@@ERROR
...
SET 
	[Description] = @Description,
	[ConfirmitLangTypeID] = @ConfirmitLangTypeID
WHERE
	[LanguageTypeID] = @LanguageTypeID
-- Get the Error Code for the statement just executed.
SELECT @ErrorCode=@@ERROR
...
-- Gets: @LocatingAttemptTypeID int
-- Gets: @LocatingAttemptType varchar(125)
-- Gets: @IsActive bit
-- Gets: @SortOrder int
...
CREATE PROCEDURE [dbo].[wiz_tlkpLocatingAttemptType_Insert]
	@LocatingAttemptTypeID int,
	@LocatingAttemptType varchar(125),
	@IsActive bit,
	@SortOrder int,
...
-- [Stored Procedures generated for view:  vwCaseAssignmentSearch]

GO

-- //// Select All Stored procedure.
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[wiz_vwCaseAssignmentSearch_SelectAll]') and OBJECTPROPERTY(id, N'IsProcedure') = 1) drop procedure [dbo].[wiz_vwCaseAssignmentSearch_SelectAll]
GO

---------------------------------------------------------------------------------
-- Stored procedure that will select all rows from the view 'vwCaseAssignmentSearch'
-- Returns: @ErrorCode int
---------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[wiz_vwCaseAssignmentSearch_SelectAll]
	@ErrorCode int OUTPUT
AS
SET NOCOUNT ON
-- SELECT all rows from the view.
SELECT
	...
	[AddressSourceType],
	[MoreFieldAttempts]
FROM [dbo].[vwCaseAssignmentSearch]
-- Get the Error Code for the statement just executed.
SELECT @ErrorCode=@@ERROR
GO


-- [End of Stored Procedures for view:     vwCaseAssignmentSearch]
