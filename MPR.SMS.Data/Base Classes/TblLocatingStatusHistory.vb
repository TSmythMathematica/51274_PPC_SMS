...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tblLocatingStatusHistory.
	''' </summary>

	Public Class TblLocatingStatusHistory
...
#Region "Private Fields"
		...
		Private _locatingStatusHistoryID As SqlInt32
		Private _locatingStatusHistoryIDOld As SqlInt32
...
#End Region
		...
		''' <overloads>
		''' The TblLocatingStatusHistory constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TblLocatingStatusHistory class.
		''' </summary>
		...
		Private Sub FillProperties(ByVal objDataRow As DataRow)
			...
			_locatingStatusHistoryID = New SqlInt32(CType(objDataRow("LocatingStatusHistoryID"), Integer))
			
			_locatingStatusHistoryIDOld = _locatingStatusHistoryID
		...
		Private Sub FillProperties(ByVal objSqlDataReader As SqlDataReader)
			...
			_locatingStatusHistoryID = New SqlInt32(CType(objSqlDataReader("LocatingStatusHistoryID"), Integer))
		...
		Friend Sub RestoreModified()
			...
			_locatingStatusHistoryID = _locatingStatusHistoryIDOld
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_Insert]"
			...
			Try
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingStatusHistoryID", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, _locatingStatusHistoryID))
				...
				_locatingStatusHistoryID = CType(cmdToExecute.Parameters.Item("@LocatingStatusHistoryID").Value, SqlInt32)
				mErrorCode = CType(cmdToExecute.Parameters.Item("@ErrorCode").Value, SqlInt32)

				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				cmdToExecute.Parameters.Add(New SqlParameter("@LocatingStatusHistoryID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingStatusHistoryID))
				cmdToExecute.Parameters.Add(New SqlParameter("@LocatingStatusID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingStatusID))
				cmdToExecute.Parameters.Add(New SqlParameter("@Round", SqlDbType.Int, 4, ParameterDirection.Input, True, 10, 0, "", DataRowVersion.Proposed, _round))
				cmdToExecute.Parameters.Add(New SqlParameter("@CaseID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _caseID))
				cmdToExecute.Parameters.Add(New SqlParameter("@MPRID", SqlDbType.VarChar, 8, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Proposed, _mPRID))
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		''' <summary>
		''' Update method for updating one or more rows using the Foreign Key 'LocatingStatusID.
		''' It will reset the field 'LocatingStatusID' in
		''' all rows which have as value for this field the value as set in property 'LocatingStatusIDOld' to 
		''' the value as set in property 'LocatingStatusID'.
		''' </summary>
		''' <returns>True if succeeded, otherwise an exception is thrown. </returns>
		''' <remarks>
		''' Properties needed for this method: 
		...
		''' </UL>
		''' </remarks>
		Public Function UpdateAllWLocatingStatusIDLogic() As Boolean
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_UpdateAllWLocatingStatusIDLogic]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingStatusID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _locatingStatusID))
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingStatusIDOld", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingStatusIDOld))
				cmdToExecute.Parameters.Add(new SqlParameter("@ErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, mErrorCode))
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_UpdateAllWLocatingStatusIDLogic' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::UpdateAllWLocatingStatusIDLogic::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingStatusHistory")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingStatusHistory")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		''' <summary>
		''' Selects one or more rows from the database based on the Foreign Key 'LocatingStatusID'
		''' </summary>
		''' <returns>DataTable object if succeeded, otherwise an Exception is thrown. </returns>
		''' <remarks>
		''' Properties needed for this method: 
		...
		''' </UL>
		''' </remarks>
		Public Function SelectAllWLocatingStatusIDLogic() As DataTable
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingStatusHistory_SelectAllWLocatingStatusIDLogic]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingStatusHistory")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingStatusHistory_SelectAllWLocatingStatusIDLogic' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingStatusHistory::SelectAllWLocatingStatusIDLogic::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
...
#Region "Public Properties"
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [LocatingStatusHistoryID]() As SqlInt32
			Get
				Return _locatingStatusHistoryID
			End Get
			Set(ByVal Value As SqlInt32)
				If Not _locatingStatusHistoryID.Equals(Value) Then
					If _locatingStatusHistoryIDOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _locatingStatusHistoryID.Equals(_locatingStatusHistoryIDOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
				Dim locatingStatusHistoryIDTmp As SqlInt32 = Value
				If locatingStatusHistoryIDTmp.IsNull Then
					Throw New NullValueException("LocatingStatusHistoryID", "LocatingStatusHistoryID can't be NULL")
				End If
				_locatingStatusHistoryID = Value
			End Set
		End Property
		...
		Public Property [LocatingStatusID]() As SqlInt32
			...
			End Set
		End Property
		Protected Property [LocatingStatusIDOld]() As SqlInt32
			Get
				Return _locatingStatusIDOld
			End Get
			Set(ByVal Value As SqlInt32)
				Dim locatingStatusIDOldTmp As SqlInt32 = Value
				If locatingStatusIDOldTmp.IsNull Then
					Throw New NullValueException("LocatingStatusIDOld", "LocatingStatusIDOld can't be NULL")
				End If
				_locatingStatusIDOld = Value
			End Set
		End Property
