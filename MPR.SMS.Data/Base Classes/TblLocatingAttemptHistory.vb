...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tblLocatingAttemptHistory.
	''' </summary>

	Public Class TblLocatingAttemptHistory
...
#Region "Private Fields"
		...
		Private _locatingAttemptHistoryID As SqlInt32
		Private _locatingAttemptHistoryIDOld As SqlInt32
...
#End Region
		...
		''' <overloads>
		''' The TblLocatingAttemptHistory constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TblLocatingAttemptHistory class.
		''' </summary>
		...
		Private Sub FillProperties(ByVal objDataRow As DataRow)
			...
			_locatingAttemptHistoryID = New SqlInt32(CType(objDataRow("LocatingAttemptHistoryID"), Integer))
			
			_locatingAttemptHistoryIDOld = _locatingAttemptHistoryID
		...
		Private Sub FillProperties(ByVal objSqlDataReader As SqlDataReader)
			...
			_locatingAttemptHistoryID = New SqlInt32(CType(objSqlDataReader("LocatingAttemptHistoryID"), Integer))
		...
		Friend Sub RestoreModified()
			...
			_locatingAttemptHistoryID = _locatingAttemptHistoryIDOld
		...
		''' <UL>
		'''		 <LI>LocatingAttemptHistoryID</LI>
		'''		 <LI>ErrorCode</LI>
		''' </UL>
		''' </remarks>
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_Insert]"
			...
			Try
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingAttemptHistoryID", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, _locatingAttemptHistoryID))
				...
				_locatingAttemptHistoryID = CType(cmdToExecute.Parameters.Item("@LocatingAttemptHistoryID").Value, SqlInt32)
				mErrorCode = CType(cmdToExecute.Parameters.Item("@ErrorCode").Value, SqlInt32)

				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				cmdToExecute.Parameters.Add(New SqlParameter("@LocatingAttemptHistoryID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingAttemptHistoryID))
				cmdToExecute.Parameters.Add(New SqlParameter("@LocatingAttemptID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingAttemptID))
				cmdToExecute.Parameters.Add(New SqlParameter("@Round", SqlDbType.Int, 4, ParameterDirection.Input, True, 10, 0, "", DataRowVersion.Proposed, _round))
				cmdToExecute.Parameters.Add(New SqlParameter("@CaseID", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _caseID))
				cmdToExecute.Parameters.Add(New SqlParameter("@MPRID", SqlDbType.VarChar, 8, ParameterDirection.Input, False, 0, 0, "", DataRowVersion.Proposed, _mPRID))
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		''' <summary>
		''' Update method for updating one or more rows using the Foreign Key 'LocatingAttemptID.
		''' It will reset the field 'LocatingAttemptID' in
		''' all rows which have as value for this field the value as set in property 'LocatingAttemptIDOld' to 
		''' the value as set in property 'LocatingAttemptID'.
		''' </summary>
		''' <returns>True if succeeded, otherwise an exception is thrown. </returns>
		''' <remarks>
		''' Properties needed for this method: 
		...
		''' </UL>
		''' </remarks>
		Public Function UpdateAllWLocatingAttemptIDLogic() As Boolean
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_UpdateAllWLocatingAttemptIDLogic]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingAttemptID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _locatingAttemptID))
				cmdToExecute.Parameters.Add(new SqlParameter("@LocatingAttemptIDOld", SqlDbType.Int, 4, ParameterDirection.Input, False, 10, 0, "", DataRowVersion.Proposed, _locatingAttemptIDOld))
				cmdToExecute.Parameters.Add(new SqlParameter("@ErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, mErrorCode))
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_UpdateAllWLocatingAttemptIDLogic' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::UpdateAllWLocatingAttemptIDLogic::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingAttemptHistory")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingAttemptHistory")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		''' <summary>
		''' Selects one or more rows from the database based on the Foreign Key 'LocatingAttemptID'
		''' </summary>
		''' <returns>DataTable object if succeeded, otherwise an Exception is thrown. </returns>
		''' <remarks>
		''' Properties needed for this method: 
		...
		''' </UL>
		''' </remarks>
		Public Function SelectAllWLocatingAttemptIDLogic() As DataTable
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tblLocatingAttemptHistory_SelectAllWLocatingAttemptIDLogic]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tblLocatingAttemptHistory")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tblLocatingAttemptHistory_SelectAllWLocatingAttemptIDLogic' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TblLocatingAttemptHistory::SelectAllWLocatingAttemptIDLogic::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
...
#Region "Public Properties"
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [LocatingAttemptHistoryID]() As SqlInt32
			Get
				Return _locatingAttemptHistoryID
			End Get
			Set(ByVal Value As SqlInt32)
				If Not _locatingAttemptHistoryID.Equals(Value) Then
					If _locatingAttemptHistoryIDOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _locatingAttemptHistoryID.Equals(_locatingAttemptHistoryIDOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
				Dim locatingAttemptHistoryIDTmp As SqlInt32 = Value
				If locatingAttemptHistoryIDTmp.IsNull Then
					Throw New NullValueException("LocatingAttemptHistoryID", "LocatingAttemptHistoryID can't be NULL")
				End If
				_locatingAttemptHistoryID = Value
			End Set
		End Property
		...
		Public Property [LocatingAttemptID]() As SqlInt32
			...
			End Set
		End Property
		Protected Property [LocatingAttemptIDOld]() As SqlInt32
			Get
				Return _locatingAttemptIDOld
			End Get
			Set(ByVal Value As SqlInt32)
				Dim locatingAttemptIDOldTmp As SqlInt32 = Value
				If locatingAttemptIDOldTmp.IsNull Then
					Throw New NullValueException("LocatingAttemptIDOld", "LocatingAttemptIDOld can't be NULL")
				End If
				_locatingAttemptIDOld = Value
			End Set
		End Property
