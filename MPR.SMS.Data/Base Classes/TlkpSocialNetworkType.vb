...
Namespace BaseClasses
	...
	''' <summary>
	''' Data access class for the table named tlkpSocialNetworkType.
	''' </summary>

	Public Class TlkpSocialNetworkType
		Inherits DBInteractionBase

#Region "Private Fields"

		Private _rank As SqlInt32
		Private _rankOld As SqlInt32
...
#End Region
		...
		''' <overloads>
		''' The TlkpSocialNetworkType constructor has two overloads.
		''' </overloads>
		''' <summary>
		''' Initializes a new instance of the TlkpSocialNetworkType class.
		''' </summary>
		...
		Private Sub FillProperties(ByVal objDataRow As DataRow)
			...
			If objDataRow("Rank") Is System.DBNull.Value Then
				_rank = SqlInt32.Null
			Else
				_rank = New SqlInt32(CType(objDataRow("Rank"), Integer))
			End If
		...
		Private Sub FillProperties(ByVal objSqlDataReader As SqlDataReader)
			...
			If objSqlDataReader("Rank") Is System.DBNull.Value Then
				_rank = SqlInt32.Null
			Else
				_rank = New SqlInt32(CType(objSqlDataReader("Rank"), Integer))
			End If
		...
		''' <UL>
		'''		 <LI>Description</LI>
		'''		 <LI>Rank. May be SqlInt32.Null</LI>
		''' </UL>
		...
		Overrides Public Function Insert() As Boolean
			...
			cmdToExecute.CommandText = "dbo.[wiz_tlkpSocialNetworkType_Insert]"
			...
			Try
				...
				cmdToExecute.Parameters.Add(New SqlParameter("@Rank", SqlDbType.Int, 4, ParameterDirection.Input, True, 10, 0, "", DataRowVersion.Proposed, _rank))
				cmdToExecute.Parameters.Add(new SqlParameter("@SocialNetworkTypeID", SqlDbType.Int, 4, ParameterDirection.Output, True, 10, 0, "", DataRowVersion.Proposed, _socialNetworkTypeID))
				...
				_socialNetworkTypeID = CType(cmdToExecute.Parameters.Item("@SocialNetworkTypeID").Value, SqlInt32)
				mErrorCode = CType(cmdToExecute.Parameters.Item("@ErrorCode").Value, SqlInt32)

				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpSocialNetworkType_Insert' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpSocialNetworkType::Insert::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
		...
		Overrides Public Function Update() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpSocialNetworkType_Update]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpSocialNetworkType_Update' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpSocialNetworkType::Update::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function Delete() As Boolean
			...
			Dim cmdToExecute As SqlCommand	= New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpSocialNetworkType_Delete]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpSocialNetworkType_Delete' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return True
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpSocialNetworkType::Delete::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectOne() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpSocialNetworkType_SelectOne]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpSocialNetworkType")
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpSocialNetworkType_SelectOne' reported the ErrorCode: " & mErrorCode.ToString())
				End If
			...
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpSocialNetworkType::SelectOne::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
		...
		Overrides Public Function SelectAll() As DataTable
			Dim cmdToExecute As SqlCommand = New SqlCommand()
			cmdToExecute.CommandText = "dbo.[wiz_tlkpSocialNetworkType_SelectAll]"
			cmdToExecute.CommandType = CommandType.StoredProcedure
			Dim toReturn As DataTable = new DataTable("tlkpSocialNetworkType")
			Dim adapter As SqlDataAdapter = new SqlDataAdapter(cmdToExecute)
			...
			Try
				...
				If Not mErrorCode.Equals(New SqlInt32(DataAccessError.OK)) Then
					' Throw error.
					Throw New Exception("Stored Procedure 'wiz_tlkpSocialNetworkType_SelectAll' reported the ErrorCode: " & mErrorCode.ToString())
				End If

				Return toReturn
			Catch ex As Exception
				' Some error occured. Bubble it to caller and encapsulate Exception object
				Throw New Exception("TlkpSocialNetworkType::SelectAll::Error occured." + Environment.Newline + Environment.NewLine + ex.Message, ex)
			Finally
				If mblnConnectionIsLocal Then
					' Close connection.
					mobjSqlConnection.Close()
...
#Region "Public Properties"
		...
		Public Property [SocialNetworkTypeID]() As SqlInt32
			...
			Set(ByVal Value As SqlInt32)
				If Not _socialNetworkTypeID.Equals(Value) Then
					...
					End If
				End If 
				Dim socialNetworkTypeIDTmp As SqlInt32 = Value
				If socialNetworkTypeIDTmp.IsNull Then
					Throw New NullValueException("SocialNetworkTypeID", "SocialNetworkTypeID can't be NULL")
				End If
		...
		DefaultValue:="", _
		IsTimeStamp:=False)> _
		Public Property [Rank]() As SqlInt32
			Get
				Return _rank
			End Get
			Set(ByVal Value As SqlInt32)
				If Not _rank.Equals(Value) Then
					If _rankOld.Equals(Value) Then
						ModifiedColumnCount -= 1
					ElseIf _rank.Equals(_rankOld) Then
						ModifiedColumnCount += 1
					End If
				End If 
				_rank = Value
